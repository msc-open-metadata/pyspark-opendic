...
class OpenDicCatalog(Catalog):
    ...
    def sql(self, sqlText : str):
        ...
        # Syntax: CREATE [OR REPLACE] [TEMPORARY] OPEN <object_type> <name> [IF NOT EXISTS] [AS <alias>] <arguments>
        opendic_create_pattern = (
            ...
            r"(?:\s+(?P<arguments>.*))?"            # Remaining arguments
        )
        ...
        if create_match:
            ...
            arguments = create_match.group('arguments')  
